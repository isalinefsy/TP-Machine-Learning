import pandas as pd
import numpy as np
from sklearn.ensemble import GradientBoostingClassifier  # Importation de GradientBoostingClassifier
...
submission.to_csv('../data/GradientBoosting_submission.csv', index=False)
print("Fichier de soumission '../data/GradientBoosting_submission.csv' généré avec succès !")
